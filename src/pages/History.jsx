...
const History = () => {
  ...
  const deleteHistory = async (id) => {
    await removeHistoryAPI(id) //no need of any result... therefore we can call it directly without assigning into a variable
    getAllHistory() //inorder to display remaining datas after deleting a data call this  api
  }
